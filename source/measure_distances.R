          ...
          tryCatch({
            ...
            while(strand_count<no_strands){
              ...
              if (as.numeric(num_strands$s.area[strand_count])<120 & as.numeric(num_strands$s.area[strand_count])>50){
                ...
                #print("centre pixel at (x,y) =")
                ##display(noise_gone)
                #text(x = cx, y = cy, label = "+", col = "red", cex = 2)
                #### if eccentricity > 0.9 then go to point.
                ...
                if(moment_info$m.eccentricity > 0.5){
                  ...
                  ##display(noise_gone)
                  #text(x = mean_x, y = mean_y, label = "+", col = "blue", cex = 2)
                  ##
                  ...
                  ##display(new_square_1)
                  ##display(new_square_2)
                  ...
                  while(first_dir == 0){
                    ...
                    #display(walkers)
                    #display(rgbImage(noise_gone, walkers, walkers))
                  ...
                  while(second_dir == 0){
                    ...
                    if (dir_2 == 3 ){
                      ...
                      # sqaure matrix but wrong dimensions! (double)
                      ix_4 <- seq(from = window+1, to = 2*window+1, by = 1)
                      iy_4 <- seq(from = window+1, to = 2*window+1, by = 1)
                  ...
                  if (width(per_strand_obj) ==2){
                    ...
                    dim_length <- dist_between_foci/(distance_strand+ distance_strand_2-4)
